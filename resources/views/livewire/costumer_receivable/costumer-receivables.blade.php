<div class="row sales layout-top-spacing">
            ...
            <div class="widget-heading">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        @endcan
                        <div class="col-sm-3">
                            <a href="{{ url('costumer_report/pdf' . '/' . $my_total . '/' . $search) }}" class="btn btn-dark btn-md" target="_blank">
                                Generar PDF
                            </a>
                        </div>
                        {{--<div class="col-sm-3">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h6 class="text-center">{{$client->costumer}}</h6></td>   
                                <td><h6 class="text-center">{{$client->description}}</h6></td>
                                <td><h6 class="text-center">${{number_format($client->amount,2)}}</h6></td>
                                <td class="text-center">
                                    <button wire:click.prevent="Details({{$client->id}})" class="btn btn-dark mtmobile" title="Detalles">
                                        <i class="fas fa-list"></i>
                                    </button>
                                    @can('editar_registro')
                                    <a href="javascript:void(0)" wire:click.prevent="Edit({{$client->id}})" class="btn btn-dark mtmobile" title="Editar" data-toggle="modal" data-target="#theModal2">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @endcan
                                    @can('eliminar_registro')
                                    <a href="javascript:void(0)" onclick="Confirm('{{$client->id}}')" class="btn btn-dark mtmobile" title="Eliminar">
    ...
    @include('livewire.costumer_receivable.form')
    @include('livewire.costumer_receivable.form2')
    @include('livewire.costumer_receivable.detail')
    @include('livewire.costumer_receivable.data_import')
</div>
