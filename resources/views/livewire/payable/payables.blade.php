<div class="row sales layout-top-spacing">
            ...
            <div class="widget-heading">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        @endcan
                        <div class="col-sm-3">
                            <a href="{{ url('payable_report/pdf' . '/' . $my_total . '/' . $search) }}" class="btn btn-dark btn-md" target="_blank">
                                Generar PDF
                            </a>
                        </div>
                        {{--<div class="col-sm-3">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h6 class="text-center">{{$payable->reference}}</h6></td>   
    ...
    @include('livewire.payable.form')
    @include('livewire.payable.form2')
    @include('livewire.payable.detail')
    @include('livewire.payable.data_import')
</div>
